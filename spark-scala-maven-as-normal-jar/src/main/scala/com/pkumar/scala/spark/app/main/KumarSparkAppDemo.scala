package com.pkumar.scala.spark.app.main;

import org.apache.spark.SparkConf
import org.apache.spark.SparkContext
import java.io.File

object KumarSparkAppDemo extends App {
	...
	val dataArr=Array(9,77,33,44,56,78,23,45,6,7,77,9,77,33,44,56,78,23,45,6,7,77,45,6,7,77)
